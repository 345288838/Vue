<template>
    <div class="" v-if="stayhome">
            ...
            <div class="container clearfix">
                <section class="clearfix topic">
                    <div class="detail-title">
                        ...
                        <div class="tag">
                            <span class="tag-1" v-for="(item,index) in stayhome.stag" :key="index">{{item}}</span>
                            <!--                        <span class="tag-2">已消毒</span>-->
                        </div>
                    </div>
                    <div class="rank">
                        <div class="num">{{stayhome.score}}</div>
                ...
                <section class="tabs">
                    <van-tabs>
                        <van-tab title="详情">
                            ...
                            <p class="desc" v-html="stayhome.sdesc">
                                {{stayhome.sdesc}}
                            </p>
                            <div class="more">
                            ...
                            <div class="check-in-notice">
                                ...
                                <div class="notie-container">
                                    ...
                                    <div class="notice-item">
                                        ...
                                        <span class="notice-des" v-html="stayhome.snotice">
                                            <span>{{stayhome.snotice}}</span>
                                        </span>    
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="recommend-item" v-for="(item, index) in recommend" :key="index">
                                    <router-link :to="{name:'detail',query:{sid:item.sid}}">
                                        <div class="recommend-item-img">
                                            <van-image class="recommend-img" :src="item.sthumb"></van-image>
                                            <div class="like">
                                        ...
                                        <div class="recommend-item-star">
                                            <div class="recommend-star-container clear-fix">
                                                <div class="recommend-star float-left" v-for="(star,index) in item.score" :key="index+1">
                                                    <van-image :src="icon.star"></van-image>
                                                </div>
                                                <div class="recommend-star float-left" v-for="(star,index) in (5 - item.score)" :key="index">
        ...
        <footer>
            ...
            <div class="collect float-left" @click="handelCollection">
                    <i class="iconfont icon-xin" v-show="!isCollection" ></i>
                    <van-image v-show="isCollection" :src="icon.favorites"/>
                    <div>1.1k收藏</div>
            </div>
            <div class="price float-left">
                ...
                <div class="order-btn float-left" @click="handelOrder">立即预定</div>
        </footer>
        <!-- 底部结束 -->
    </div>
</template>
...
import {detail,collection} from "../../http";
    ...
    methods: {
        ...
        handelCollection(){
            if (this.$store.state.token){
                this.$store.commit('toCollection',this.$route.query.sid*1);
                let params=this.$store.state.collection.join(',');
        ...
        handelOrder(){
            if (!sessionStorage.getItem('token')){
                Toast({
                    ...
                    this.$router.push({name:'Log',query:{redirect:'detail',params:{sid:this.sid}}})
            }else {
